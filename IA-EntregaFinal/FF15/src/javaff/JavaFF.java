...
public class JavaFF
{
    ...
    public static State performSearch(TemporalMetricState initialState) {
    	...
    	//infoOutput.println("Performing Best First Search (Greedy Search)...");
    	//infoOutput.println("Performing Enforced Hill Climbing search...");
    	infoOutput.println("Performing A-Star Search search...");
    	
    	State goalState;		
    	//BreadthFirstSearch BrFS = new BreadthFirstSearch(initialState);
    	...
    	AStarSearch AST = new AStarSearch(initialState);
    	
    	//BrFS.setFilter(NullFilter.getInstance());
    	//BFS.setFilter(NullFilter.getInstance());
    	//EHC.setFilter(NullFilter.getInstance());
    	//EHC.setFilter(HelpfulFilter.getInstance());
    	
    	AST.setFilter(NullFilter.getInstance());
    	
    	goalState = AST.search();
