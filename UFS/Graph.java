...
public class Graph{
	public static void main(String[] args){
		//inicializar a base do gráfico no mapa da Romênia
	...
	public static void UFS(Node source, Node goal){
		
		source.pathCost = 0;
		PriorityQueue<Node> queue = new PriorityQueue<Node>(20, 
			new Comparator<Node>(){

			//substitui o método de comparação
		...
		do{
			...
			//termine se o caminho for encontrado
			...
			for(Edge e: current.adjacencies){
				Node child = e.target;
				double cost = e.cost;
				//adicionar nó à fila se o nó não tiver sido explorado
				...
				//o caminho atual é mais curto do que o caminho anterior encontrado
